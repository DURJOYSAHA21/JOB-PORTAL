    ...
    xhttp.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200) {
            ...
            if(result.is_verified == 1) {
                ...
                setTimeout(function() { window.location.href = "../../../view/recruiter/recruiter-dashboard-view.php"; }, 1500);
            } else if(result.is_active == 0) {
                document.getElementById("checkMsg").innerHTML = "Account suspended. Logging out...";
                setTimeout(function() { window.location.href = "../../../controller/recruiter/recruiter-logout-controller.php"; }, 1500);
            } else {
                document.getElementById("checkMsg").innerHTML = "Still pending. Checking again in 10 seconds...";
            }
        }
    };
    xhttp.open("POST", "../../../controller/recruiter/recruiter-waiting-controller.php", true);
