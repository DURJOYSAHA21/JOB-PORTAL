function validateRegisterForm() {
    ...
    if(phone == "") {
        ...
        document.getElementById("phone-error").innerHTML = "Invalid Phone Number (10 digits required)";
        valid = false;
    }
    ...
    if(password == "") {
        ...
        document.getElementById("password-error").innerHTML = "Password must contain uppercase, lowercase, number, and special character";
        valid = false;
    }
