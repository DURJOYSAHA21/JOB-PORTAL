...
<body>
    <div class="box">
        ...
        <p>Thank you for registering as an employer on HireHub. Your account is currently under review.</p>
        <div class="info-box">
            <p><strong>What happens next?</strong><br><br>
            Our admin team will review your company details and verify your account. This usually takes 1-2 business days.</p>
        </div>
        ...
        <a class="logout" href="../../controller/logout-controller.php">Logout</a>
    </div>

    <script>
        var userId = <?php echo (int)$_SESSION["user"]["id"]; ?>;
    </script>
    <script src="../../controller/api/waiting.js"></script>
</body>
</html>