...
<body>
    ...
    <main class="main-panel">
        ...
        <div class="main-panel-form">
            ...
            <form method="POST" action="../../controller/personal-info-controller.php" id="register-form" onsubmit="return validateRegisterForm()">
            ...
            <button type="button" class="btnnext" onclick="window.location.href='company-info-view.php';">Next Step</button>
        </div>
    </main>
